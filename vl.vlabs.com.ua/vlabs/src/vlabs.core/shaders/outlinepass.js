...
module.exports = function(THREE, EffectComposer) {
    function OutlinePass ( resolution, scene, camera, selectedObjects ) {
        if (!(this instanceof OutlinePass)) return new OutlinePass(resolution, scene, camera, selectedObjects);
        ...
        EffectComposer.MaskPass.call( this );
    ...
    OutlinePass.prototype = Object.assign( Object.create( EffectComposer.MaskPass.prototype ), {
